...
#  Created by Genus(TM) Synthesis Solution 21.10-p002_1 on Wed Apr 08 15:40:07 CEST 2026
...
set_driving_cell -lib_cell INVX1 -pin "Y" [get_ports resetn]
set_driving_cell -lib_cell INVX1 -pin "Y" [get_ports ser_rx]
set_driving_cell -lib_cell INVX1 -pin "Y" [get_ports flash_io0]
set_driving_cell -lib_cell INVX1 -pin "Y" [get_ports flash_io1]
set_driving_cell -lib_cell INVX1 -pin "Y" [get_ports flash_io2]
set_driving_cell -lib_cell INVX1 -pin "Y" [get_ports flash_io3]
...
set_clock_uncertainty -hold 0.10 [get_clocks flash_clk]
