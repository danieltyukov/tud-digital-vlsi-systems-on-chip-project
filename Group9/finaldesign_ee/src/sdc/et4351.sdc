...
# Setup: 0.10ns (accounts for jitter accumulation across cycles)
# Hold:  0.05ns (same-cycle check, no inter-cycle jitter accumulation)
set_clock_uncertainty -setup $CLK_UNCERTAINTY [all_clocks]
