module accelerator_fft #(
  ...
  localparam signed [MEM_WIDTH-1:0] TWIDDLE_ONE = 32'sd4096;
  localparam signed [MEM_WIDTH-1:0] TWIDDLE_NEG_ONE = -32'sd4096;
  localparam signed [MEM_WIDTH-1:0] TWIDDLE_ZERO = 32'sd0;
  ...
  assign twiddle_is_pos_one = (w_re_lut == TWIDDLE_ONE) && (w_im_lut == TWIDDLE_ZERO);
  assign twiddle_is_neg_one = (w_re_lut == TWIDDLE_NEG_ONE) && (w_im_lut == TWIDDLE_ZERO);
  assign twiddle_is_pos_j = (w_re_lut == TWIDDLE_ZERO) && (w_im_lut == TWIDDLE_ONE);
  assign twiddle_is_neg_j = (w_re_lut == TWIDDLE_ZERO) && (w_im_lut == TWIDDLE_NEG_ONE);
