...
#  Created on Wed Apr  8 14:32:22 2026                
#                                                     
#######################################################
...
group_path -name in2reg_tmp.2852422 -from {0x10ad 0x10b0} -to 0x10b1 -ignore_source_of_trigger_arc
getOptMode -allowPreCTSClkSrcPaths -quiet
set_global _is_ipo_interactive_path_groups 1
group_path -name in2out_tmp.2852422 -from {0x10b8 0x10bb} -to 0x10bc -ignore_source_of_trigger_arc
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2reg_tmp.2852422 -from 0x10c2 -to 0x10c7
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2out_tmp.2852422 -from 0x10d2 -to 0x10d7
set_global _is_ipo_interactive_path_groups 1
group_path -name clkgate_tmp.2852422 -to 0x10d9
setPathGroupOptions reg2reg_tmp.2852422 -effortLevel high
reset_path_group -name reg2out_tmp.2852422
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name in2reg_tmp.2852422
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name in2out_tmp.2852422
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name clkgate_tmp.2852422
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name reg2reg_tmp.2852422
set_global _is_ipo_interactive_path_groups 0
...
getOptMode -allowPreCTSClkSrcPaths -quiet
set_global _is_ipo_interactive_path_groups 1
group_path -name in2reg_tmp.2852422 -from {0x1114 0x1117} -to 0x1118 -ignore_source_of_trigger_arc
getOptMode -allowPreCTSClkSrcPaths -quiet
set_global _is_ipo_interactive_path_groups 1
group_path -name in2out_tmp.2852422 -from {0x111f 0x1122} -to 0x1123 -ignore_source_of_trigger_arc
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2reg_tmp.2852422 -from 0x1129 -to 0x112e
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2out_tmp.2852422 -from 0x1139 -to 0x113e
set_global _is_ipo_interactive_path_groups 1
group_path -name clkgate_tmp.2852422 -to 0x1140
setPathGroupOptions reg2reg_tmp.2852422 -effortLevel high
reset_path_group -name reg2out_tmp.2852422
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name in2reg_tmp.2852422
