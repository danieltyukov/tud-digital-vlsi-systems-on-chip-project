...
create_analysis_view -name analysis_view_hold -constraint_mode constraint_mode -delay_corner delay_min -latency_file ${::IMEX::libVar}/mmmc/latency.1.sdc
set_analysis_view -setup [list analysis_view_setup analysis_view_power] -hold [list analysis_view_hold analysis_view_power]
catch {set_interactive_constraint_mode [list constraint_mode] } 
