module accelerator_fft #(
  ...
  assign twiddle_is_neg_one = (w_re == TWIDDLE_NEG_ONE) && (w_im == TWIDDLE_ZERO);
  assign twiddle_is_pos_j = (w_re == TWIDDLE_ZERO) && (w_im == TWIDDLE_ONE);
  assign twiddle_is_neg_j = (w_re == TWIDDLE_ZERO) && (w_im == TWIDDLE_NEG_ONE);
