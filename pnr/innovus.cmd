...
#  Created on Fri Mar 13 00:31:53 2026                
#                                                     
#######################################################
...
group_path -name in2reg_tmp.2422174 -from {0xa0 0xa3} -to 0xa4 -ignore_source_of_trigger_arc
getOptMode -allowPreCTSClkSrcPaths -quiet
set_global _is_ipo_interactive_path_groups 1
group_path -name in2out_tmp.2422174 -from {0xab 0xae} -to 0xaf -ignore_source_of_trigger_arc
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2reg_tmp.2422174 -from 0xb5 -to 0xba
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2out_tmp.2422174 -from 0xc5 -to 0xca
setPathGroupOptions reg2reg_tmp.2422174 -effortLevel high
reset_path_group -name reg2out_tmp.2422174
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name in2reg_tmp.2422174
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name in2out_tmp.2422174
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name reg2reg_tmp.2422174
set_global _is_ipo_interactive_path_groups 0
...
getOptMode -allowPreCTSClkSrcPaths -quiet
set_global _is_ipo_interactive_path_groups 1
group_path -name in2reg_tmp.2422174 -from {0x104 0x107} -to 0x108 -ignore_source_of_trigger_arc
getOptMode -allowPreCTSClkSrcPaths -quiet
set_global _is_ipo_interactive_path_groups 1
group_path -name in2out_tmp.2422174 -from {0x10f 0x112} -to 0x113 -ignore_source_of_trigger_arc
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2reg_tmp.2422174 -from 0x119 -to 0x11e
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2out_tmp.2422174 -from 0x129 -to 0x12e
setPathGroupOptions reg2reg_tmp.2422174 -effortLevel high
reset_path_group -name reg2out_tmp.2422174
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name in2reg_tmp.2422174
