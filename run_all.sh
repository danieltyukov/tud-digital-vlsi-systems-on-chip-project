...
echo ":::: INFO :::: Exporting final clock-gated EE implementation..."
innovus -files ./scripts/30.export_cg_fix_iter11_final.tcl
cd "${PROJECT_DIR}"
...
cp -f "${PROJECT_DIR}/pnr/outputs/et4351.phys.gds" "${PROJECT_DIR}/finaldesign/et4351.phys.gds"
...
cp -f "${PROJECT_DIR}/pnr/outputs/et4351.phys.gds" "${PROJECT_DIR}/finaldesign_hp/et4351.phys.gds"
