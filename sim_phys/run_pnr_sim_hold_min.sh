...
# Compile libraries
vlog /data/Cadence/gpdk045_v60/gsclib045_svt_v4.7/gsclib045/verilog/fast_vdd1v2_basicCells.v
...
vsim testbench -c -do ./scripts/run_vcd_hold.cmd -t 1ns \
            -sdfmin /testbench/dut=../pnr/outputs/et4351.phys.sdf \
